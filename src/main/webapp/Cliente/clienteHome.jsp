<%-- 
    ...
    Created on : 1 dic. 2022, 20:32:43
    Author     : luisz
--%>
                ...
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col-9">
                                    <h2>Bienvenido a la pagina de clientes</h2>
                                </div>
                                <div class="col-3">
                                            ...
                                            <table class="table">
                                                ...
                                                <c:forEach var="cliente" items="${clientes}">
                                                    <tr> 
                                                        ...
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/clienteServlet?accion=editar&id_Cliente=${cliente.id_Cliente}">
                                                                <i class="fa-regular fa-pen-to-square"></i>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/clienteServlet?accion=eliminar&id_Cliente=${cliente.id_Cliente}">
